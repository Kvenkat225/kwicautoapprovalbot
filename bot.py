...
gif = [
    "https://telegra.ph/file/a215fe599b880f3552933.mp4",
...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(kk.id,img, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @mawabroo__**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Channel", url="https://t.me/MawaBroo"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/+W01hjKk-0881OGRl")
                    ],[
                        InlineKeyboardButton("➕ Add me to your Chat ➕", url="https://t.me/MBAutoApprovebot?startgroup")
                    ]
                ]
            )
            ...
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/MBAutoApprovebot?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
...
async def chk(_, cb : CallbackQuery):
    try:
        ...
        if cb.message.chat.type == enums.ChatType.PRIVATE:
            ...
            await cb.message.edit("**🦊 Hello {}!\nI'm an Auto Approve Bot.\n\nI can approve users in Groups/Channels.\n\nAdd me to your chat and promote me to admin with add members permission.\n\n__Powerd By : @MawaBroo__**".format(cb.from_user.mention, "https://t.me/telegram/153"), reply_markup=keyboard, disable_web_page_preview=True)
